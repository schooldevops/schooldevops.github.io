...
layout: post
title:  "SDKMan 이용하기 "
date:   2021-05-25 11:45:49 +0900
categories: Tools
tags: [Java, SDK, SDKMAN, sdkman]
toc: true
---
...
[SDKMan](https://sdkman.io/) 에서 내용을 확인해 보자. 
...
- candidate: 이것은 제공하는 SDK의 종류를 나타낸다. groovy, scala, grails, gradle, kotlin 등이 있을 수 있으며, 자세한 사항은 [SDKMan sdklist](https://sdkman.io/sdks) 에서 확인할 수 있다. 
...
[사용법](https://sdkman.io/usage) 에서 상세한 사용법을 확인할 수 있다. 
